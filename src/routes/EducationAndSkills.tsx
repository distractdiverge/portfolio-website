...
function EducationAndSkills() {
  useSeo({ 
    ...
    description: 'Technical expertise: Python, TypeScript, Java, .NET, AWS. Enterprise architecture, system integration, 15+ years experience. MS Software Engineering, Drexel.' 
  });
